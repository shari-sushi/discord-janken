    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-zinc-700 p-6 rounded-lg mb-6">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed" onClick={handleUpdate} disabled={isLoading || !key || !value}>
            UPDATE
          </button>
