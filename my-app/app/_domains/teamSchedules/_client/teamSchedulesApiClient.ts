import type { DayKey, ScheduleStatus, SessionUser, TeamManagementMode, TeamSchedule, TeamSummary, TeamWebhookSettings, TeamWebhooksUpdate, WebhookProvider } from "@/app/_domains/teamSchedules/types"
